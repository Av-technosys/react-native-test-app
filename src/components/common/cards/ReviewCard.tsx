          ...
          {videos.length > 0 && (
            <FlatList
              ...
              renderItem={({ item }) => {
                ...
                return (
                  <View className="w-28 h-28 rounded-lg overflow-hidden bg-black relative">
                    <Video
                      source={{ uri: videoUrl }}
                    ...
                    />
                    {/* PLAY ICON OVERLAY */}
                    <View className="absolute top-2 right-2 w-6 h-6 bg-black/70 rounded-full items-center justify-center">
